...
{{--    <link href="{{$setting->font}}" rel="stylesheet">--}}
    ...
    <link rel="preload" href="{{asset('_nuxt/e3c5ee1.js')}}" as="script" />
    <link rel="preload" href="{{asset('_nuxt/d094e50.js')}}" as="script" />
    <link rel="preload" href="{{asset('_nuxt/7a98c72.js')}}" as="script" />
    <link rel="preload" href="{{asset('_nuxt/577a796.js')}}" as="script" />
    <link rel="preload" href="{{asset('_nuxt/static/1654788385/united-kingdom/state.js')}}" as="script" />
    <link rel="preload" href="{{asset('_nuxt/static/1654788385/united-kingdom/payload.js')}}" as="script" />
    <link rel="preload" href="{{asset('_nuxt/static/1654788385/manifest.js')}}" as="script" />
...
{{--            <a href="{{url('/')}}" title="{{$setting->title}}" style="color: white !important;">--}}
...
{{--    <a target="_blank" class="codeless-add-purchase-button" href="https://wa.me/{{$setting->phone}}">--}}
{{--        <i class="icon"><svg height="682pt" viewBox="-23 -21 682 682.66669" width="682pt" xmlns="http://www.w3.org/2000/svg">--}}
