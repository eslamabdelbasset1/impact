...
{{--                            <img class="blog_post_image img-fluid lazy" width="800" height="550" src="/public/img/loading-blog.gif" data-src="{{$post->photo ? '/images/media/' . $post->photo->file : '/public/img/200x200.png'}}" alt="{{$post->title}}">--}}
{{--                          </a>--}}
{{--                      </div>--}}
...
{{--                               <img alt="" src="/public/img/loading-blog.gif" data-src="{{$post->user->photo ? '/images/media/' . $post->user->photo->file : '/public/img/200x200.png'}}" class="avatar img-fluid lazy" height="120" width="120">--}}
{{--                             </div>--}}
